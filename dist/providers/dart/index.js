...
class DartProvider {
    constructor() {
        this.id = "dart";
        this.displayName = "Dart";
        this.fileNames = ["pubspec.yaml"];
    }
    parseDocument(document) {
        return (0, parser_1.parseDartDependencies)(document);
    }
    async getLatestVersion(packageName, ignorePatterns) {
        const latest = await (0, registry_1.fetchLatestDartVersion)(packageName);
        ...
        const versions = await (0, registry_1.fetchDartVersions)(packageName);
        if (!versions) {
            return null;
        }
    ...
    async getAvailableVersions(packageName) {
        return (0, registry_1.fetchDartVersions)(packageName);
    }
...
exports.DartProvider = DartProvider;
